...
const MT_DEFAULTS=[
  {id:'mt1',name:'Full-Time',   color:'#16a34a',perms:{allTasks:true, allMeetings:true, docs:true, archive:true, projects:true, services:true, library:true, team:true, backlog:true, dashboard:true, hrComs:true, announcements:true,  todos:true, svcTest:true}},
  {id:'mt2',name:'Part-Time',   color:'#2563eb',perms:{allTasks:true, allMeetings:true, docs:true, archive:true, projects:true, services:false,library:true, team:true, backlog:false,dashboard:true, hrComs:true, announcements:true,  todos:true, svcTest:true}},
  {id:'mt3',name:'Freelancer',  color:'#d97706',perms:{allTasks:false,allMeetings:false,docs:false,archive:false,projects:false,services:false,library:false,team:false,backlog:false,dashboard:false,hrComs:false,announcements:false, todos:true, svcTest:false}},
  {id:'mt4',name:'Subcontractor',color:'#7c3aed',perms:{allTasks:false,allMeetings:false,docs:false,archive:false,projects:true, services:false,library:false,team:false,backlog:false,dashboard:false,hrComs:false,announcements:true,  todos:true, svcTest:false}},
  {id:'mt5',name:'Per-Project', color:'#be185d',perms:{allTasks:false,allMeetings:false,docs:false,archive:false,projects:true, services:false,library:false,team:false,backlog:false,dashboard:false,hrComs:false,announcements:false, todos:true, svcTest:false}},
];
