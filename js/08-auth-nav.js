...
function startReminderChecker(){
  ...
  function checkReminders(){
    ...
    if(DB.testSchedules?.length){
      ...
      const defaultReviewerId=DB.team.find(t=>t.name==='Demo Projects Manager')?.id||null;
...
function loadDemoData(){
  DB.team=[
    {id:'u1',name:'Demo CEO',role:'CEO',dept:'Management',access:'Admin',status:'Active',email:'demo.ceo@example.com',wa:'+10000000001',color:'#4f46e5',av:'DC',notes:'',username:'demo_ceo'},
    {id:'u2',name:'Demo Projects Manager',role:'Projects Manager',dept:'Management',access:'Admin',status:'Active',email:'demo.pm@example.com',wa:'',color:'#7c3aed',av:'DP',notes:'',username:'demo_pm'},
    {id:'u3',name:'Demo HR Manager',role:'HR Manager',dept:'Management',access:'Admin',status:'Active',email:'demo.hr@example.com',wa:'',color:'#b45309',av:'DH',notes:'',username:'demo_hr'},
    {id:'u4',name:'Demo Senior Developer',role:'Super Senior Developer',dept:'Engineering',access:'Member',status:'Active',email:'demo.dev1@example.com',wa:'+10000000004',color:'#0369a1',av:'DD',notes:'',username:'demo_dev1'},
    {id:'u5',name:'Demo Developer Two',role:'Senior Developer',dept:'Engineering',access:'Member',status:'Active',email:'demo.dev2@example.com',wa:'',color:'#0369a1',av:'DE',notes:'',username:'demo_dev2'},
    {id:'u6',name:'Demo Designer',role:'Front End Designer',dept:'Design',access:'Member',status:'Active',email:'demo.design@example.com',wa:'',color:'#be185d',av:'DS',notes:'',username:'demo_design'},
    {id:'u7',name:'Demo Content Manager',role:'Content Manager',dept:'Content',access:'Member',status:'Active',email:'demo.content@example.com',wa:'',color:'#047857',av:'DC2',notes:'',username:'demo_content'},
    {id:'u8',name:'Demo Sys Admin',role:'Sys Admin',dept:'Engineering',access:'Member',status:'Active',email:'demo.sysadmin@example.com',wa:'',color:'#374151',av:'DA',notes:'',username:'demo_sysadmin'},
    {id:'u9',name:'Demo Developer Three',role:'Developer',dept:'Engineering',access:'Member',status:'Active',email:'demo.dev3@example.com',wa:'',color:'#0369a1',av:'DF',notes:'',username:'demo_dev3'},
    {id:'u10',name:'Demo Developer Four',role:'Developer',dept:'Engineering',access:'Member',status:'Active',email:'demo.dev4@example.com',wa:'',color:'#0369a1',av:'DG',notes:'',username:'demo_dev4'},
  ];
  ...
  DB.tasks=[
    {id:'t1',title:'Build Qawafi Android app',status:'In Progress',priority:'Critical',type:'Feature',assignedTo:'u4',reviewer:'u2',service:'s3',operator:'o3',reqBy:'Demo CEO',due:'2026-03-20',est:40,actual:null,what:'',tech:'',rejReason:'',tsCreated:'2026-02-15T09:00:00Z',tsOpened:'2026-02-15T09:47:00Z',tsStarted:'2026-02-15T10:30:00Z',tsSubmitted:null,tsReviewed:null,tsArchived:null,rejections:[],desc:'Full Android app for Qawafi. Poem browsing, submission, rating, poet profiles.',respH:0.8,workH:null,revH:null,cycleH:null},
    {id:'t2',title:'Booktown full-text search',status:'Pending Review',priority:'High',type:'Feature',assignedTo:'u5',reviewer:'u4',service:'s5',operator:'o3',reqBy:'Demo Projects Manager',due:'2026-03-12',est:12,actual:13,what:'Elasticsearch done. Arabic analyzer working. Demo at /booktown/search on staging.',tech:'ES 8.x with Arabic analyzer. Index rebuilt nightly via cron.',rejReason:'',tsCreated:'2026-03-01T08:00:00Z',tsOpened:'2026-03-01T08:22:00Z',tsStarted:'2026-03-01T09:15:00Z',tsSubmitted:'2026-03-13T16:00:00Z',tsReviewed:null,tsArchived:null,rejections:[],desc:'Elasticsearch for Arabic book search.',respH:0.4,workH:55,revH:null,cycleH:null},
    {id:'t3',title:'Server security audit',status:'New',priority:'Critical',type:'Maintenance',assignedTo:'u8',reviewer:'u4',service:'s4',operator:'o1',reqBy:'Demo CEO',due:'2026-03-15',est:null,actual:null,what:'',tech:'',rejReason:'',tsCreated:'2026-03-08T09:00:00Z',tsOpened:null,tsStarted:null,tsSubmitted:null,tsReviewed:null,tsArchived:null,rejections:[],desc:'Full audit of all production endpoints.',respH:null,workH:null,revH:null,cycleH:null},
    {id:'t4',title:'Fix Coursat iOS video crash',status:'Done',priority:'Critical',type:'Bug Fix',assignedTo:'u5',reviewer:'u4',service:'s2',operator:'o2',reqBy:'Demo CEO',due:'2026-02-05',est:6,actual:8,what:'Fixed AVPlayer conflict. Tested iOS 15/16/17. No crashes since deployment.',tech:'Deferred AVPlayer init until native bridge ready.',rejReason:'',tsCreated:'2026-01-28T09:00:00Z',tsOpened:'2026-01-28T09:15:00Z',tsStarted:'2026-01-28T09:30:00Z',tsSubmitted:'2026-02-05T16:00:00Z',tsReviewed:'2026-02-06T10:00:00Z',tsArchived:'2026-02-06T10:05:00Z',rejections:[],desc:'iOS crash on video player.',respH:0.25,workH:8,revH:18,cycleH:226},
    {id:'t5',title:'Redesign Coursat course page',status:'In Progress',priority:'High',type:'Design',assignedTo:'u6',reviewer:'u4',service:'s2',operator:'o2',reqBy:'Demo Projects Manager',due:'2026-03-18',est:10,actual:null,what:'',tech:'',rejReason:'',tsCreated:'2026-03-05T10:00:00Z',tsOpened:'2026-03-05T11:30:00Z',tsStarted:'2026-03-06T09:00:00Z',tsSubmitted:null,tsReviewed:null,tsArchived:null,rejections:[],desc:'Mobile-first course page redesign.',respH:1.5,workH:null,revH:null,cycleH:null},
    {id:'t6',title:'April social media plan',status:'In Progress',priority:'High',type:'Content',assignedTo:'u7',reviewer:'u3',service:'s1',operator:'o1',reqBy:'Demo HR Manager',due:'2026-03-18',est:8,actual:null,what:'',tech:'',rejReason:'',tsCreated:'2026-03-10T10:00:00Z',tsOpened:'2026-03-10T14:00:00Z',tsStarted:'2026-03-11T09:00:00Z',tsSubmitted:null,tsReviewed:null,tsArchived:null,rejections:[],desc:'April social media plan for all 5 services.',respH:4,workH:null,revH:null,cycleH:null},
    {id:'t7',title:'Games Club leaderboard',status:'Rejected',priority:'High',type:'Feature',assignedTo:'u5',reviewer:'u4',service:'s4',operator:'o2',reqBy:'Demo Projects Manager',due:'2026-03-10',est:14,actual:16,what:'Built with WebSocket real-time updates.',tech:'Socket.io for real-time.',rejReason:'Missing operator filter + pagination broken.',tsCreated:'2026-02-20T10:00:00Z',tsOpened:'2026-02-20T10:45:00Z',tsStarted:'2026-02-20T11:30:00Z',tsSubmitted:'2026-03-10T14:00:00Z',tsReviewed:'2026-03-10T17:00:00Z',tsArchived:null,rejections:[{at:'2026-03-10T17:00:00Z',by:'u4',reason:'Missing operator filter + pagination broken.'}],desc:'Real-time gaming leaderboard.',respH:0.75,workH:null,revH:3,cycleH:null},
  ];
  DB.backlog=[{id:'b1',title:'AI content recommendations',status:'Approved',cat:'Feature',priority:'High',by:'Demo CEO',desc:'ML recommendations from user history.',why:'Reduces churn, increases engagement.',notes:'Approved for Q2.'},{id:'b2',title:'Offline reading — Booktown',status:'Under Review',cat:'Feature',priority:'High',by:'Demo Projects Manager',desc:'Download books for offline reading.',why:'Critical for Sudan connectivity issues.',notes:''},{id:'b3',title:'Games Club daily challenge',status:'Under Review',cat:'Feature',priority:'High',by:'Demo CEO',desc:'24h daily gaming challenge.',why:'Improves DAU significantly.',notes:'Needs leaderboard first.'}];
  ...
  DB.archive=[{id:'a1',title:'Fix Coursat iOS video crash',by:'u5',reviewer:'u4',svc:'s2',op:'o2',type:'Bug Fix',priority:'Critical',est:6,actual:8,done:'2026-02-06',what:'Fixed AVPlayer conflict. Tested iOS 15/16/17. No crashes since deployment.',outcome:'Successful',respH:0.25,workH:8,revH:18,cycleH:226,reqBy:'Demo CEO',at:'2026-02-06T10:05:00Z'}];
  DB.testSchedules=[];
  DB.testSessions=[];
  DB.testChecks=[];
  DB.meetings=[
    {id:'m1',title:'Q1 Review',description:'Review Q1 progress',meeting_date:'2026-04-20',meeting_time:'10:00',duration_minutes:60,location:'Conference Room A',meeting_type:'Internal',status:'Scheduled',created_by:'Demo CEO',invitees:['Demo Projects Manager','Demo HR Manager','Demo Senior Developer'],attendance:{},started_at:null,ended_at:null,created_at:new Date().toISOString()},
